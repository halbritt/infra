...
details remain in `config/plane/README.md` and `config/plane-public/README.md`.
...
For the `plane` local/private pilot, see `config/plane/README.md`.

For `plane-harm` / `plane.harm.org`, see `config/plane-public/README.md`.
...
- `AGENTS.md`
- `config/plane/README.md`
- `config/plane/API_TOKENS.md`
- `config/plane-public/AGENTS.md`
- `config/plane-public/README.md`
